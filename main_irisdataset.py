...
def run():
    ...
    sepal-length = st.slider('SepalLengthCm:', 2.0, 6.0)
    sepal-width = st.slider('SepalWidthCm:', 0.0, 5.0)
    petal-length = st.slider('PetalLengthCm',0.0, 3.0)
    petal-width = st.slider('SkiPetalWidthCm:', 0.0, 2.0)
    
    
    data = {'SepalLengthCm': sepal-length,
