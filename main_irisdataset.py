...
def run():
    ...
    sepal-length = st.slider('sepal-length:', 2.0, 6.0)
    sepal-width = st.slider('sepal-width:', 0.0, 5.0)
    petal-length = st.slider('petal-length:',0.0, 3.0)
    petal-width = st.slider('petal-width:', 0.0, 2.0)
